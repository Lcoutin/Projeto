...
<body>
    <header>
        <div class="progress-signup">
            ...
            <div class="steps">
                <p class="step default on" id="step-goal">Objetivo</p>
                <p class="step default on" id="step-personal-data">Dados Pessoais</p>
                <p class="step default on" id="step-photos">Galeria</p>
